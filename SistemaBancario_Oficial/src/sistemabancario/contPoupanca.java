 ...
 */
public class contPoupanca extends javax.swing.JFrame {
...
public void variacao()
    {
        ...
        else if(saldo>9500000)
        {
            ...
            textVariacao.setText("Sev valor inserido");
    }
    ...
    private void initComponents() {
        ...
        textVariacao = new javax.swing.JTextField();
        ...
        jPanel1.add(textTelefone, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 190, 500, 30));

        textEndereco.setFont(new java.awt.Font("Garamond", 1, 18)); // NOI18N
        jPanel1.add(textEndereco, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 130, 500, 30));

        textNome.setFont(new java.awt.Font("Garamond", 1, 18)); // NOI18N
        jPanel1.add(textNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 500, 30));
        ...
        jPanel1.add(textNif, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 300, 500, 30));
        ...
        jPanel1.add(jcmbMes, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 480, 200, -1));
        ...
        jPanel1.add(jcmbAno, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 480, 110, -1));
        ...
        jPanel1.add(jcmbdia, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 480, 110, -1));
        ...
        jPanel1.add(txt_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, 500, 30));
        ...
        jPanel1.add(jcmbSexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 440, 500, -1));

        txtSaldo.setFont(new java.awt.Font("Garamond", 0, 18)); // NOI18N
        jPanel1.add(txtSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 340, 593, -1));
        ...
        jPanel1.add(txtiban, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 410, 600, -1));

        textVariacao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textVariacaoActionPerformed(evt);
            }
        });
        jPanel1.add(textVariacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 380, 500, -1));
    ...
    private void textVariacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textVariacaoActionPerformed
        // TODO add your handling code here:
        
    }//GEN-LAST:event_textVariacaoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contPoupanca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new contPoupanca().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField textVariacao;
